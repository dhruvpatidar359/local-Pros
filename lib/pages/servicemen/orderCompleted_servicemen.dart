...
import 'package:localpros/pages/servicemen/orderCard_servicemen.dart';
import 'package:localpros/wingets/loading.dart';
import 'package:mysql1/mysql1.dart';
import 'package:shared_preferences/shared_preferences.dart';

class OrderCompeletedServicemen extends StatefulWidget {
  const OrderCompeletedServicemen({super.key});

  @override
  State<OrderCompeletedServicemen> createState() => _OrderCompeletedServicemenState();
}

class _OrderCompeletedServicemenState extends State<OrderCompeletedServicemen> {
  ...
  void getData() async {
    ...
    result = await databaseService.fetchOrdersServicemen(email, "completed");
