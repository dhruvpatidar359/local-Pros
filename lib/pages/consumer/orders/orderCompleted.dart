...
class OrderCompeleted extends StatefulWidget {
  const OrderCompeleted({super.key});

  @override
  State<OrderCompeleted> createState() => _OrderCompeletedState();
}

class _OrderCompeletedState extends State<OrderCompeleted> {
  ...
  void getData() async {
    result = await databaseService.fetchOrders(email, "completed");
